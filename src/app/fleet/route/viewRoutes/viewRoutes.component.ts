...
export class ViewRoutesComponent implements OnInit {
  ...
  //   this.routeDetailsList = this.basicInfo.routeDetails;
  //   console.log("daownload data ")
  //   console.log(this.routeDetailsList)
  //   debugger;
  //   this.routeDetailsList.push([
  //     { text: 'Sr#', bold: true },
  //     { text: 'Latitude', bold: true },
  //     { text: 'Longitude', bold: true },
  //     { text: 'Distance', bold: true },
  //     { text: 'Link Name', bold: true }
  //   ]);

  //   this.routeDetailsList.forEach((routeDetailsList, i) => {
  //     debugger;
  //     this.routeDetailsList.push([
  //       { text: (i + 1).toString(), alignment: 'right' },
  //       { text: this.basicInfo.routeDetails.numLatitude, alignment: 'left' },
  //       { text: this.basicInfo.routeDetails.numLongitude, alignment: 'left' },
  //       { text: this.basicInfo.routeDetails.numRouteDistance, alignment: 'left' },
  //       { text: this.basicInfo.routeDetails.txt_name, alignment: 'left' }
  ...
  downloadPDF() {
      ...
      content: [
        {
          ...
          table: {
            ...
            body: [
              ...
              [{
                text: 'RouteReport', style: 'tableHeaderValue', alignment: 'center', headerRows: 1,
          ...
          table: {
            ...
            body: [
              ...
              [
                ...
                { text: this.basicInfo.code, style: 'tableHeaderValue' },
                { text: 'Route Name:', style: 'tableHeader' },
                { text: this.basicInfo.name, style: 'tableHeaderValue' }
              ],
              [
                { text: 'Total Distance', style: 'tableHeader' },
                { text: this.basicInfo.totalDistance, style: 'tableHeaderValue' },
                { text: 'Route Type', style: 'tableHeader' },
                {text:this.basicInfo.txtRouteType, style: 'tableHeaderValue'}
              ],

              // [
              //   tableHeader.push({ text: 'Sr:', style: 'tableHeader' }),
              //   tableHeader.push({ text: 'Latitude:', style: 'tableHeader' }),
              //   tableHeader.push({ text: 'Longitude:', style: 'tableHeader' }),
              //   tableHeader.push({ text: 'Distance:', style: 'tableHeader' }),
              //   tableHeader.push({ text: 'Link Name:', style: 'tableHeader' })

              // ],
              // [
              //   tableRows.push({ text: this.routeDataList.routeDetails.numLatitude, style: 'tableHeaderValue' }),
              //   tableRows.push({ text: this.routeDataList.routeDetails.numLongitude, style: 'tableHeaderValue' }),
              //   tableRows.push({ text: this.routeDataList.routeDetails.routeDetails.numRouteDistance, style: 'tableHeaderValue' }),
              //   tableRows.push({ text: this.routeDataList.routeDetails.routeDetails.txt_name, style: 'tableHeaderValue' })
              // ],
            ]
          },
        ...
        // { text: 'Documents:', fontSize: 14, bold: true, margin: [0, 50, 0, 0] },
        // {
        //   style: 'tableExample',
        //   table: {
        //     headerRows: 1,
        //     body: this.routeDetailsList
        //   }
        // },
      ],
      styles: {
    ...
    pdfMake.createPdf(documentDefinition).download('Route Detail.pdf');
  }


  // body: [
  //   ['Zone / Branch:', { text: this.basicInfo.txtBranchName} ],
  //   ['Union Council',  { text: this.basicInfo.txtLocationName }],
  //   ['Route No:', { text: this.basicInfo.code }],               
  //   ['Route Name:',  { text: this.basicInfo.name }],
  //   ['Distance:', { text: this.basicInfo.distance }],
