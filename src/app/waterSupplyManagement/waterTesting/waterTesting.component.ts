...
onSearch(){
  ...
  let dteDateFrom = this.dateFormat.transformToStandardDateTime(this.waterTestingForm.controls.dteDateFrom.value);
    let dteDateTo = this.dateFormat.transformToStandardDateTime(this.waterTestingForm.controls.dteDateTo.value);
  ...
  this.billingService.getWaterTestServiceByParams(dteDateFrom,dteDateTo,txtAssetType,serBranchId,serLocationId,txtConsumerType,txtTestResult,txtTestingAgency).subscribe(response => {
...
onGet(){
  this.billingService.getWaterTestService().subscribe(response => {
    console.log(response.data);
    this.tubewellDataList = response.data;
    debugger;
    this.isLoading = false;
    this.waterTestListData = new MatTableDataSource(response.data);
    this.waterTestListData.sort = this.waterTestSort;
  ...
  onEdit(id:any){
    debugger;
    var waterTestDto :any;
    this.billingService.updateWaterTestServiceById(id,waterTestDto).subscribe( response => {
      console.log(response)
    })
  ...
  setStep(index: number) {
    ...
    pdfImplementation() {
     debugger;
      ...
      // ['branch','unionCouncil','txtAssetType', 'txtConsumerType',  'numConsumerNo' ,'txtSamplingDate', 'txtSamplingPoint', 'txtTestingAgency','txtResultSubmissionDate', 'txtTestResult','Actions'];
