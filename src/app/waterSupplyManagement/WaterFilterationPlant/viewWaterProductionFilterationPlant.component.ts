...
@Component({
    ...
    templateUrl:'./viewWaterProductionFilterationPlant.component.html'
    
    
})
export class ViewWaterProductionFilterationPlantComponent implements OnInit {
    // @Input() vewData: any[]=[];
    @Input() vewData : string[];
    Id: any = "";
    viewData:any[]=[];  
    
  viewWaterProdInfo: any;
  txtProductName:any;
  txtProductCode:any;
    constructor(
    ...
    //   this.txtProductCode = queryParams.get("txtProductCode");
     
    // });
        //   this.billingService.getWaterProductionListServiceByID(this.Id).subscribe( response => {
        //       console.log(response)
        //       this.viewWaterProdInfo = response;
        //   })
...
downloadPDF() {
      ...
      content: [
        {
          ...
          table: {
            ...
            body: [
              ...
              [{ text: 'WaterProductionReport', style: 'tableHeaderValue', alignment: 'center',          headerRows: 1,
            ...
            }],
              {
                ...
                height: 70,
                alignment: 'right', margin: [20, 5, 55, 0],
              }],
        ...
        },
        {
          ...
          table: {
            ...
            body: [
              ...
              [
                { text: 'Filteration Plant Number:', style: 'tableHeader' },
                { text: this.viewData[0].txtProductCode, style: 'tableHeaderValue' },
                { text: 'Filteration Plant Name:', style: 'tableHeader' },
                { text: this.viewData[0].txtProductName, style: 'tableHeaderValue' }

              ],
              [
                { text: 'Monthly Bill:', style: 'tableHeader' },
                { text: this.viewData[0].numMonthlyBill, style: 'tableHeaderValue' },
                { text: 'Functional:', style: 'tableHeader' },
                { text: this.viewData[0].blnIsFunctional, style: 'tableHeaderValue' }
              ],
              [
                { text: 'Metered Connection:', style: 'tableHeader' },
                { text: this.viewData[0].blnIsMetered, style: 'tableHeaderValue' },
                { text: 'Total Running Hour:', style: 'tableHeader' },
                { text: this.viewData[0].numTotalRunningHours, style: 'tableHeaderValue' }
              ],
              [
                { text: 'Avg Discharge m3/hr', style: 'tableHeader' },
                { text: this.viewData[0].txtAverageDischargePerHour, style: 'tableHeaderValue' },
                { text: 'Total Produced m3/hr:', style: 'tableHeader' },
                { text: this.viewData[0].numWaterProducedInHour, style: 'tableHeaderValue' }
                
              ],
              [
                { text: 'Total Running Unit:', style: 'tableHeader' },
                { text: this.viewData[0].numTotalRunningUnit, style: 'tableHeaderValue' },
                { text: 'Avg Discharge m3/unit:', style: 'tableHeader' },
                { text: this.viewData[0].txtAverageDischargePerUnit, style: 'tableHeaderValue' }
              ],
              [
                { text: 'Total Electricity Units Consume:', style: 'tableHeader' },
                { text: this.viewData[0].numUnitConsumed, style: 'tableHeaderValue' },
    ...
    pdfMake.createPdf(documentDefinition).download('Water Production Detail.pdf');
  }
}
