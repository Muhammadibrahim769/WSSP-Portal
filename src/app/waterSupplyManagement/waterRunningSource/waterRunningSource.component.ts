...
@Component({
  ...
  templateUrl: './waterRunningSource.component.html',
  providers: [
    {
      provide: DateAdapter,
...
export class WaterRunningSourceComponent implements OnInit {
  ...
  waterProductionColumn: string[] = [  'txtBranchName', 'txtLocationName', 'txtProductCode', 'txtReferanceNo','txtProductName','txtDischargeCalculation',
    'numTotalRunningHours', 'txtAverageDischargePerHour', 'numWaterProducedInHour', 'TotalRunningUnit', 'txtAverageDischargePerUnit',
  ...
  onSubmit() {
    ...
    this.billingService.searchWaterProductionTubewell(txtItemType, txtMonth, txtProductCode, txtProductName, serBranchId, serLocationId).subscribe(response => {
      debugger;
  ...
  openEditModel(element) {
    ...
    console.log(this.searchWaterRunningForm.value)
    const EditData = this.dialog.open(EditWaterProductionModalComponent, {
      data: element
  ...
  onView(element) {
    ...
    this.router.navigate(['/waterSupplyManagement/waterProduction/viewwaterProduction']);
  }
  ...
  pdfImplementation() {
    ...
    this.tubewellReportDTOList.push([
      ...
      { text: 'TubeWell Number', bold: true },
      { text: 'TubeWell Name', bold: true },
  ...
  downloadPDF() {
    ...
    this.selection.value.forEach(element => {
      ...
      } else if (element === "txtProductCode") {
        tableHeader.push({ text: 'TubeWell Number', bold: true, fillColor: '#dddddd', alignment: 'center' });
      } else if (element === "txtProductName") {
        tableHeader.push({ text: 'TubeWell Name', bold: true, fillColor: '#dddddd', alignment: 'center' });
