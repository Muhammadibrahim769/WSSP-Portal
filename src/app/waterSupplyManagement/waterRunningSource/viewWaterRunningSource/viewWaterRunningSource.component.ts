...
@Component({
    ...
    templateUrl: 
    './viewWaterRunningSource.component.html'
    
    
})
export class ViewWaterRunningSourceComponent implements OnInit {
    // @Input() vewData: any[]=[];
        ...
        },
        {
          ...
          table: {
            ...
            body: [
              ...
              [
                { text: 'Total Produced Cubic Per/Month:', style: 'tableHeader' },
