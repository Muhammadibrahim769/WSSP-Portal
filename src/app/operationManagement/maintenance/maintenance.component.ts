...
export class MaintenanceComponent implements OnInit {
  ...
  generalOperationColumns: string[] = ['serNo', 'branch', 'unionCouncil', 'txtLine', 'numLength', 'numDiameter', 'txtMaterial', 'txtMaintainanceReferenceNo', 'txtCategory', 'dteInstallationDate', 'dteMaintainanceDate', 'txtArea','Actions'];
  ...
  ngOnInit(): void {
    ...
    this.getBranchList();
    this.maintenanceForm.controls['serBranchId'].valueChanges.subscribe(element => {
  ...
  onSubmit() {
    let dteDateFrom = '';
    if (this.maintenanceForm.controls.dteDateFrom.value != "") {
      dteDateFrom = this.dateFormat.transformOperation(this.maintenanceForm.controls.dteDateFrom.value)
    }
    let dteDateTo = '';
    if (this.maintenanceForm.controls.dteDateTo.value != "") {
      dteDateTo = this.dateFormat.transformOperation(this.maintenanceForm.controls.dteDateTo.value)
    }
    let serLocationId = this.maintenanceForm.controls.serLocationId.value;
    let serBranchId = this.maintenanceForm.controls.serBranchId.value;
    let txtLineType = this.maintenanceForm.controls.txtLineType.value;
    let txtReferenceNumber = this.maintenanceForm.controls.txtReferenceNumber.value;
    this.billingService.getMaintanceList(serBranchId, serLocationId, txtLineType, txtReferenceNumber, dteDateFrom, dteDateTo).subscribe(response => {
      debugger;
      this.selectStatusList = [];
      console.log(response);
      this.responseList = response

      this.generalOperation = new MatTableDataSource(response);
  ...
  openEditModel(element) {
    ...
    const EditData = this.dialog.open(EditMaintenanceComponent, {
      data: element
  ...
  onReset() {
    this.maintenanceForm.controls.serBranchId.reset('')
    this.maintenanceForm.controls.serLocationId.reset('')
    this.maintenanceForm.controls.txtBranchName.reset('')
    this.maintenanceForm.controls.txtLocationName.reset('')
    this.maintenanceForm.controls.txtLineType.reset('')
    this.maintenanceForm.controls.txtReferenceNumber.reset('')
    this.maintenanceForm.controls.dteDateFrom.reset('')
    this.maintenanceForm.controls.dteDateTo.reset('')
    this.onSubmit();
  }
