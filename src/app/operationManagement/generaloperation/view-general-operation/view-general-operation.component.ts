          ...
          table: {
            ...
            body: [
              ...
              [
                ...
                { text: 'RPC Manholes Cleaned:', style: 'tableHeader' },
              ...
              [
                ...
                { text: 'Sewerage Lines Repair:', style: 'tableHeader' },
                { text: this.viewData[0].numSewerageLinesRepaired, style: 'tableHeaderValue', alignment: 'right' }
              ],
              [
                { text: 'RCC Manholes Cleaned:', style: 'tableHeader' },
                { text: this.viewData[0].numSecMhCleaned, style: 'tableHeaderValue', alignment: 'right' },
                { text: 'PeIronGrid Manholes Cleanedriod:', style: 'tableHeader' },
                { text: this.viewData[0].numTerMhCleaned, style: 'tableHeaderValue', alignment: 'right' }
              ],
              [
                { text: 'Sewerage Lines Cleaned:', style: 'tableHeader' },
                { text: this.viewData[0].numSewerageLinesCleaned, style: 'tableHeaderValue', alignment: 'right' },
                { text: 'Sewerage Lines Discelitation:', style: 'tableHeader' },
                { text: this.viewData[0].numSewerageLineDiscelitation, style: 'tableHeaderValue', alignment: 'right' }
            ...
            layout: 'noBorders'
              ...
              { text: 'Water Supply:', fontSize: 14, bold: true, margin: [0, 10, 0, 0] },
{
          style: 'tableExample',
          table: {
            headerRows: 1,
            ...
            body: [
              ...
              [
                ...
                { text: this.viewData[0].numDrainageLinesRepaired, style: 'tableHeaderValue', alignment: 'right' },
              ...
              [
                ...
                { text: this.viewData[0].numDrainageLinesCleaned, style: 'tableHeaderValue', alignment: 'right' }
                ],
              [
                { text: 'Drainage Lines Discelitation:', style: 'tableHeader' },
                { text: this.viewData[0].numDrainageLinesDiscelitation, style: 'tableHeaderValue', alignment: 'right' },
                { text: 'Distribution Lines Discelitation:', style: 'tableHeader' },
                { text: this.viewData[0].numDistributionLinesDiscelitation, style: 'tableHeaderValue', alignment: 'right' }
              ],
            ]
          },
          // layout: 'noBorders'
