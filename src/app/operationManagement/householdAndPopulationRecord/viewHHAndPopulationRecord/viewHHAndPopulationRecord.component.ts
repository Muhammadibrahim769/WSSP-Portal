...
export class ViewHHAndPopulationRecordComponent implements OnInit {
  Id: any = "";
  numTotalHouseHold: number;
  houseHoldDetails: any;
  constructor(private dialog: MatDialog, private route: ActivatedRoute, private billingService: BillingService, private numberFormat: CustomFormatterPipe) { }
  ...
  downloadPDF() {
    const documentDefinition = {
      ...
      content: [
          ...
          table: {
            ...
            body: [
              [
                ...
                { text: this.houseHoldDetails.txtBranchName, style: 'tableHeaderValue' },
                { text: 'Union Council:', style: 'tableHeader' },
                { text: this.houseHoldDetails.txtLocationName, style: 'tableHeaderValue' }
              ]
            ]
          },
          layout: 'noBorders'
        },
        { text: 'Sewerage:', fontSize: 14, bold: true, margin: [0, 20, 0, 0] },
        {
          style: 'tableExample',
          table: {
            headerRows: 1,
            ...
            body:
              [
                [
                  { text: 'No Of RPC Manholes:', style: 'tableHeader' },
                  { text: this.houseHoldDetails.numTotalMainholes, style: 'tableHeaderValue' },
                  { text: 'No Of RCC Manholes:', style: 'tableHeader' },
                  { text: this.houseHoldDetails.numTotalSecMainholes, style: 'tableHeaderValue' }
                ],
                [
                  { text: 'No Of IronGrid Mainholes:', style: 'tableHeader' },
                  { text: this.houseHoldDetails.numTotalTerMainholes, style: 'tableHeaderValue' },
                  { text: 'Primary Sewerage Lines (km):', style: 'tableHeader' },
                  { text: this.houseHoldDetails.numTotalSewerageLines, style: 'tableHeaderValue' }
                ],
                [
                  { text: 'Secondary Sewerage Lines (km):', style: 'tableHeader' },
                  { text: this.houseHoldDetails.numTotalSecondarySewerageLines, style: 'tableHeaderValue' },
                  { text: '' },
                  { text: '' }
                ],
              ]
        ...
        { text: 'Water Supply:', fontSize: 14, bold: true, margin: [0, 20, 0, 0] },
        {
          style: 'tableExample',
          table: {
            headerRows: 1,
            ...
            body:
              [
                [
                  { text: 'Primary Drainage Line (km):', style: 'tableHeader' },
                  { text: this.houseHoldDetails.numPriDrainageLines, style: 'tableHeaderValue' },
                  { text: 'Secondary Drainage Line (km):', style: 'tableHeader' },
                  { text: this.houseHoldDetails.numSecDrainageLines, style: 'tableHeaderValue' }
                ],
                [
                  { text: 'Pri Distribution NW:', style: 'tableHeader' },
                  { text: this.houseHoldDetails.numPriDistributedNetworkLines, style: 'tableHeaderValue' },
                  { text: 'Sec Distribution NW:', style: 'tableHeader' },
                  { text: this.houseHoldDetails.numSecDistributedNetworkLines, style: 'tableHeaderValue' }
                ],               
              ]
          },
          layout: 'noBorders'
        },
        { text: 'Population:', fontSize: 14, bold: true, margin: [0, 20, 0, 0] },
        {
          style: 'tableExample',
          table: {
            headerRows: 1,
            ...
            body: [
              [
                { text: 'Total Population:', style: 'tableHeader' },
                { text: this.houseHoldDetails.numTotalPopulation, style: 'tableHeaderValue' },
                { text: 'Total HouseHold:', style: 'tableHeader' },
                { text: this.houseHoldDetails.numTotalHouseHold, style: 'tableHeaderValue' }
              ],
              [
                { text: 'Avg Member / House:', style: 'tableHeader' },
                {
              ...
              [
                ...
                { text: this.houseHoldDetails.txtRemarks, style: 'tableHeaderValue', colSpan: 3 },
    ...
    pdfMake.createPdf(documentDefinition).download('HousHold Detail.pdf');
  }
}
