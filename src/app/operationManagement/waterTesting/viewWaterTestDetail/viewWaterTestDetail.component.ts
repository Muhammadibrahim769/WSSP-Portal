...
@Component({
    ...
    templateUrl: './viewWaterTestDetail.component.html'
})
export class ViewWaterTestDetailComponent implements OnInit {
    Id: any = "";
    basicInfo: any;
    branchList:any;
  ...
  // utilsFunctions: any;
    ...
    constructor(private billingService: BillingService, private route: ActivatedRoute,private utilsFunctions : UtilsFunctions,private dateFormat: DateFormatPipe ) { }
    ...
    ngOnInit() {
      ...
      // })
        ...
        this.billingService.getWaterTestServiceById(this.Id).subscribe(response =>{
            ...
            let branchName = this.basicInfo.serBranchId +'';
            console.log("branchName: ",branchName)
            let locationName = this.basicInfo.serLocationId +'';
            console.log("locationName: ",locationName)
            this.editWaterTestListData = new MatTableDataSource(response["lstWaterTestingDocuments"]);
    ...
    downloadPDF() {
          ...
          content: [
            {
              ...
              table: {
                ...
                body: [
                  ...
                  [{ text: 'WaterTestingReport', style: 'tableHeaderValue', alignment: 'center',          headerRows: 1,
                  margin: [100, 40, 150, 0], bold: true, fontSize: 14
                }],
                  {
              ...
              table: {
                ...
                body: [
                  ...
                  [
                    ...
                    { text: this.basicInfo.numLatitude, style: 'tableHeaderValue' },
                    { text: 'Longitude:', style: 'tableHeader' },
                    { text: this.basicInfo.numLongitude, style: 'tableHeaderValue' },
                  ],
                  [
                    { text: 'Testing Agency:', style: 'tableHeader' },
                    { text: this.basicInfo.txtTestingAgency, style: 'tableHeaderValue' },
                    { text: 'Testing Type:', style: 'tableHeader' },
                    { text: this.basicInfo.txtTestingType, style: 'tableHeaderValue' }                
                  ],
                  [
                    { text: 'Sampling Date:', style: 'tableHeader' },
                    { text: this.dateFormat.transformOperation(this.basicInfo.txtSamplingDate), style: 'tableHeaderValue' },

                    // { text: this.basicInfo.txtSamplingDate, style: 'tableHeaderValue' },

                    { text: 'Asset Type:', style: 'tableHeader' },
                    { text: this.basicInfo.txtAssetType, style: 'tableHeaderValue' }
                  ],
                  [
                    { text: 'Sampling Point:', style: 'tableHeader' },
                    { text: this.basicInfo.txtSamplingPoint, style: 'tableHeaderValue' },
                    { text: 'Consumer No:', style: 'tableHeader' },
                    { text: this.basicInfo.numConsumerNo , style: 'tableHeaderValue' }
                    ],
                  [
                    { text: 'Address', style: 'tableHeader' },
                    { text: this.basicInfo.txtAddress, style: 'tableHeaderValue' },
                    { text: 'Consumer Name', style: 'tableHeader' },
                    { text: this.basicInfo.txtConsumerName, style: 'tableHeaderValue' },
                     ],
                  [
                    { text: 'Street Name:', style: 'tableHeader' },
                    { text: this.basicInfo.txtStreetName, style: 'tableHeaderValue' },
                    { text: 'Consumer Type:', style: 'tableHeader' },
                    { text: this.basicInfo.txtConsumerType, style: 'tableHeaderValue' }
                    ],
                  [
                    { text: 'Test Result:', style: 'tableHeader' },
                    { text: this.basicInfo.txtTestResult, style: 'tableHeaderValue' },
                    { text: 'Result Submission Date:', style: 'tableHeader' },
                    { text: this.dateFormat.transformOperation(this.basicInfo.txtResultSubmissionDate), style: 'tableHeaderValue' },

                    // { text: this.basicInfo.txtResultSubmissionDate, style: 'tableHeaderValue' }
                     ],
                  [
                    { text: 'Result Attachment:', style: 'tableHeader' },
                    {  },
                    { text: 'Comments/Remarks:', style: 'tableHeader' },
                    { text: this.basicInfo.txtComments, style: 'tableHeaderValue' }
                     /* <th>
                            <h6>Result Attachment:</h6>
                        </th>
                        <td>file no.1</td>
                        <th>
        ...
        pdfMake.createPdf(documentDefinition).download('Water Testing Detail.pdf');
      }
