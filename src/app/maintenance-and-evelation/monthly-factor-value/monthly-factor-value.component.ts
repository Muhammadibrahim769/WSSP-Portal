...
@Component({
  ...
  templateUrl: './monthly-factor-value.component.html',
  providers: [
    {
      provide: DateAdapter,
...
export class MonthlyFactorValueComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.billingService.searchMonthlyExpenseSheetDataService(txtMonth).subscribe((response) => {
      debugger;
      console.log(" M & E response", response)
