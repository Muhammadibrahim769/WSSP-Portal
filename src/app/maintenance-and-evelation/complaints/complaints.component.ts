...
export class ComplaintsComponent implements OnInit {
  ...
  generalOperationColumns: string[] = ['serNo', 'branch', 'unionCouncil','numDogsStrayed','numSpray','numBillsDistributed','numRatsKilled', 'txtMonth','numTotalWaterComplaints', 'numTotalComplaints','numWasteWaterComplaints','numSolidWasteComplaints','numComplainresolvedWatersupply','numComplainresolvedWasteWater','numComplainresolvedsolidwaste'];
  ...
  ngAfterViewInit() { }
  clearPeriod() {
    this.complaintForm.controls.txtMonth.reset('');
  }
  // date = new FormControl(moment());

  chosenYearHandler(normalizedYear: Moment) {
    const ctrlValue = this.complaintForm.controls.txtMonth.value;
    ctrlValue.year(normalizedYear.year());
    this.complaintForm.controls.txtMonth.setValue(ctrlValue);
  }
  ...
  chosenMonthHandler(normalizedMonth: Moment, datepicker: MatDatepicker<Moment>) {
    ...
    console.log(this.complaintForm.controls.txtMonth);
    datepicker.close();
  }
  ...
  ngOnInit(): void {
    ...
    this.getBranchList();
    this.complaintForm.controls['serBranchId'].valueChanges.subscribe(element => {
  ...
  onSubmit() {
    ...
    let txtMonth = this.dateFormat.transform(this.complaintForm.controls.txtMonth.value);
    let serBranchId = this.complaintForm.controls.serBranchId.value;
    let serLocationId = this.complaintForm.controls.serLocationId.value;

    console.log(txtMonth);
    // let brachID = this.complaintForm.controls.txtBranchName.value;
    // let UcID = this.complaintForm.controls.txtLocationName.value;
    this.billingService.getComplaint(txtMonth, serBranchId, serLocationId).subscribe(response => {
  ...
  tableColumn: string[] = [
    ...
    "numSolidWasteComplaints",
   "numComplainresolvedWatersupply",
   "numComplainresolvedWasteWater",
   "numComplainresolvedsolidwaste",
  ...
  onReset(){
    this.complaintForm.controls.serBranchId.reset('')
    this.complaintForm.controls.serLocationId.reset('')
    this.complaintForm.controls.txtBranchName.reset('')
    this.complaintForm.controls.txtLocationName.reset('')       
    this.onSubmit();
  }
