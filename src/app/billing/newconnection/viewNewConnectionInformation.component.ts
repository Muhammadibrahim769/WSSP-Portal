...
@Component({
  selector: 'app-dashboard',
    templateUrl:'./viewNewConnectionInformation.component.html'
  })
  export class viewNewConnectionInformationComponent implements OnInit {
    ...
    ngOnInit() {
      ...
      this.billingService.getDumpCustomerListServiceByID(this.Id).subscribe( response => {
        ...
        // if(response["lstCustomerDocumentDto"].length === 0){
        ...
        content: [
          {
            ...
            table: {
              ...
              },  [{ text: 'New Connection', style: 'dateHeader', alignment: 'center', margin: [200, 60, 150, 0], bold: true, fontSize: 16 }],
  ...
  //  { text: 'New Connection:', fontSize: 14, bold: true },
      ...
      pdfMake.createPdf(documentDefinition).download('New Connection Detail.pdf');
    }
    doccolumn: string[] = [ 'documentName', 'txtDocumentReferenceNo', 'download'];
