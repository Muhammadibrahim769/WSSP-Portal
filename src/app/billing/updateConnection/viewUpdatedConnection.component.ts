...
@Component({
    selector: 'app-viewUpdatedConnection',
      templateUrl:'./viewUpdatedConnection.component.html'
    })
    export class ViewUpdatedConnectionComponent implements OnInit {

        Id: any = "";
        basicInfo: any;
        documentColumn: string[] = [ 'documentName', 'txtDocumentReferenceNo', 'download'];
        documentDatasource = new MatTableDataSource();
        isLoading = true;
        show = false;

        constructor(private route: ActivatedRoute, private billingService: BillingService,private dateFormat:DateFormatPipe, private utilsFunctions: UtilsFunctions) {}
        ...
        ngOnInit() {
            this.route.paramMap.subscribe((params) => {
              ...
              this.billingService.getDumpCustomerListServiceByID(this.Id).subscribe( response => {
                ...
                this.documentDatasource = new MatTableDataSource(response["lstCustomerDocumentDto"]);
          ...
          downloadPDF() {
            const documentDefinition = {
              ...
              content: [
                ...
                //  { text: 'New Connection:', fontSize: 14, bold: true },
                {
                  style: 'tableExample',
                  table: {
                    headerRows: 1,
                    widths: [200, 220, 200, 220],
                    body: [
                      [
                        { text: 'Zone/Branch:', style: 'tableHeader' },
                        { text: this.basicInfo.branch.name, style: 'tableHeaderValue' },
                        { text: 'Union Council:', style: 'tableHeader' },
                        { text: this.basicInfo.unionCouncil.name, style: 'tableHeaderValue' },
        
                      ],
                      [
                        { text: 'Connection Type:', style: 'tableHeader' },
                        { text: this.basicInfo.txtConnectionType, style: 'tableHeaderValue' },
                        { text: 'Consumer ID:', style: 'tableHeader' },
                        { text: this.basicInfo.txtCustomerCode, style: 'tableHeaderValue' }
        
                      ],
                      [
        
                        { text: 'Bussiness Name:', style: 'tableHeader' },
                        { text: this.basicInfo.txtBusinessName, style: 'tableHeaderValue' },
                        { text: 'Cnic:', style: 'tableHeader' },
                        { text: this.basicInfo.txtCnicNo, style: 'tableHeaderValue' }
        
                      ],
                      [
        
                        { text: 'Old Parcel Id:', style: 'tableHeader' },
                        { text: this.basicInfo.txtReferenceCode, style: 'tableHeaderValue' },
                        { text: 'Connection date:', style: 'tableHeader' },
                        { text:this.dateFormat.transformOperation(this.basicInfo.dteModifiedDate.toString()) , style: 'tableHeaderValue' }
        
                      ],
                      [
        
                        { text: 'NTN:', style: 'tableHeader' },
                        { text: this.basicInfo.txtNtnNo, style: 'tableHeaderValue' },
                        { text: 'STN:', style: 'tableHeader' },
                        { text: this.basicInfo.txtStnNo, style: 'tableHeaderValue' }
        
                      ],
                      [
        
                        { text: 'Area:', style: 'tableHeader' },
                        { text: this.basicInfo.txtShippingAddress, style: 'tableHeaderValue' },
                        { text: 'Sector Mohallah', style: 'tableHeader' },
                        { text: this.basicInfo.txtMohallah, style: 'tableHeaderValue' },
        
        
                      ],
                      [
        
                        { text: 'Street No:', style: 'tableHeader' },
                        { text: this.basicInfo.txtStreetNo, style: 'tableHeaderValue' },
                        { text: 'House No', style: 'tableHeader' },
                        { text: this.basicInfo.txtHouseNo, style: 'tableHeaderValue' },
        
        
                      ],
                      [
        
                        { text: 'Cell No:', style: 'tableHeader' },
                        { text: this.basicInfo.txtMobileNo, style: 'tableHeaderValue' },
                        { text: 'Status', style: 'tableHeader' },
                        { text: this.basicInfo.txtStatus, style: 'tableHeaderValue' },
                      ],
        
        
                      // [  
                      //   { text: 'Tender Description:', style: 'tableHeader' },
                      //   { text: this.basicInfo.txtTenderDescription, style:'tableHeaderValue', colSpan: 3 },
            ...
            pdfMake.createPdf(documentDefinition).download('Update Connection Detail.pdf');
          }
    }