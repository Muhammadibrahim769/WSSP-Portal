...
@Component({
  selector: 'app-viewSuspendInfo',
    templateUrl:'./viewSuspendInfo.component.html'
  })
  export class ViewSuspendInfoComponent implements OnInit {
    ...
    ngOnInit() {
      ...
      this.shared.currentMessage.subscribe(response => {
        debugger;
        this.billingService.getSuspensionCustomerByCode(response["txtCustomerCode"]).subscribe(data=>{
          this.basicInfo= data;
