...
@Component({
  selector: 'app-documentUploadModal',
  templateUrl: 'documentUploadModal.component.html',
})
export class DocumentUploadDialogComponent {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<DocumentUploadDialogComponent>, private formBuilder: FormBuilder) { }
  ngOnInit() {
