...
export class GeneraloperationComponent implements OnInit {
  ...
  openEditModel(element) {
    ...
    console.log(this.generalOperationForm.value)
    const EditData = this.dialog.open(EditGeneralOperationWasteComponent, {
      data: element
  ...
  onView(element) {
    ...
    this.router.navigate(['/wasteManagement/generalOperation/viewGeneralOperation']);
  ...
  pdfImplementation() {
    ...
    debugger;
     this.tubewellReportDTOList.push([
      ...
      { text: 'No of IronGrit Mainholes Repaired', bold: true },
      ...
      { text: 'Sewerage Line Desilation', bold: true },      
      { text: 'Drainage Line Desilation', bold: true },
      { text: 'Distribution Line Desilation', bold: true }
    ]);
  ...
  downloadPDF() {
    ...
    this.selection.value.forEach(element => {
      if (element === "sr") {
        ...
        tableHeader.push({ text: 'No of IronGrit Mainholes Repaired', bold: true, fillColor: '#dddddd', alignment: 'center' });
      }
        ...
        tableHeader.push({ text: 'Mainholes Cleaned', bold: true, fillColor: '#dddddd', alignment: 'center' });
        ...
        tableHeader.push({ text: 'Sewerage Line Desilation', bold: true, fillColor: '#dddddd', alignment: 'center' });
      } else if (element === "numDrainageLinesDiscelitation") {
        tableHeader.push({ text: 'Drainage Line Desilation', bold: true, fillColor: '#dddddd', alignment: 'center' });
      }     
    ...
    this.tubewellDataList.forEach((tubewellDataList, i) => {
      ...
      this.selection.value.forEach(element => {
        if (element === "sr") {
          ...
          tableRows.push({ text: tubewellDataList.numPriDrainageLinesRepaired, alignment: 'left' });
        }else if (element === "numDrainageLinesRepaired") {
          tableRows.push({ text: tubewellDataList.numPriDrainageLinesRepaired, alignment: 'left' });
        } else if (element === "numPriMhCleaned") {
          tableRows.push({ text: tubewellDataList.numPriMhCleaned, alignment: 'left' });
        }  else if (element === "numSewerageLinesCleaned") {
          tableRows.push({ text: tubewellDataList.numPriSewerageLinesCleaned, alignment: 'left' });
        } else if (element === "numDrainageLinesCleaned") {
          tableRows.push({ text: tubewellDataList.numPriDrainageLinesCleaned, alignment: 'left' });
        }  else if (element === "numSewerageLineDiscelitation") {
          tableRows.push({ text: tubewellDataList.numSecSewerageLineDiscelitation, alignment: 'left' });
        } else if (element === "numDrainageLinesDiscelitation") {
          tableRows.push({ text: tubewellDataList.numPriDrainageLinesDiscelitation, alignment: 'left' });
        }
      });
