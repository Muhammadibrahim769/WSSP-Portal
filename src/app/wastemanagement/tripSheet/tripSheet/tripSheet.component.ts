...
export class TripSheetComponent implements OnInit {
  ...
  getBatchNo: any;
  pageSize = 5;
  tripSheetColumn: string[] = ['sNo', 'txtBranchName', 'txtLocationName', 'date', 'asset_no', 'vehicle_name', 'driver_name',
    'txtRouteNo', 'txtRouteName', 'route_distance', 'distance_covered', 'trip_no', 'time_out', 'odometer_out', 'time_in',
  ...
  chosenYearHandler(normalizedYear: Moment) {
    const ctrlValue = this.form.controls.dteDate.value;
    ctrlValue.year(normalizedYear.year());
    this.form.controls.dteDate.setValue(ctrlValue);
  }
  ...
  chosenMonthHandler(normalizedMonth: Moment, datepicker: MatDatepicker<Moment>) {
    ...
    console.log(this.form.controls.dteDate);
    datepicker.close();
  }
  ...
  onChange(event) {
    debugger
    this.billingService.getBatchService(this.form.controls['txtBatchNo'].value).subscribe(response => {
      debugger;
      console.log("response");
      debugger;
      ...
      if (this.batchLIst.length != 0) {
        ...
        this.billingService.getBatchedService(this.form.controls['txtBatchNo'].value).subscribe(response => {
          debugger;
          console.log("response");
          debugger;
          console.log(response["routesLIst"]);
          ...
          if (this.batchLIst != null) {
            this.form.controls.txtDriverName.patchValue(this.batchLIst["txtEmployeeName"]);
          }
        })
      }
    })
  ...
  pdfImplementation() {    
        ...
        this.tripDataList.forEach((tripDataList, i) => {
          ...
          this.reportDtoList.push([
            ...
            { text: tripDataList.txtBranchName, alignment: 'left' },
            { text: tripDataList.txtLocationName, alignment: 'left' },
            ...
            { text: tripDataList.txt_employee_name, alignment: 'left' },
  ...
  onSubmit(form) {
    ...
    let txtMonth = this.dateFormat.transform(this.form.controls.dteDate.value);
    console.log(txtMonth);
    this.form.controls.dteDate.patchValue(txtMonth)
    let dteDate = this.form.controls.dteDate.value;
    ...
    this.billingService.getAllRecordForTripSheet(serBranchId, serLocationId, txtRouteNo, txtBatchNo, dteDate).subscribe(response => {
      debugger;      
    ...
    this.tripDataList.forEach((tripDataList, i) => {
      ...
      this.selection.value.forEach(element => {
        if (element === "sr") {
          ...
          tableRows.push({ text: tripDataList.driver_name, alignment: 'right' });
        } else if (element === "txtRouteNo") {
